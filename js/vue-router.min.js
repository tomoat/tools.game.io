...
e = function() {
    ...
    function p(t, e, r, n) {
        ...
        return r && (a.redirectedFrom = d(r, o)),
        Object.freeze(a)
    }
    function f(t) {
        if (Array.isArray(t))
    ...
    function V(e, r, n, o) {
        ...
        if (i.name) {
            var u = (i = t({}, e)).params;
            return u && "object" == typeof u && (i.params = t({}, u)),
            i
        }
    ...
    function Q(t, e) {
        ...
        function a(t, r, a) {
            ...
            if (c) {
                ...
                return s.path = M(p.path, s.params),
                u(p, s, a)
            }
            if (s.path) {
                s.params = {};
        ...
        function s(t, r) {
            ...
            var s = o
              ...
              , l = r.hash
              , d = r.params;
            return h = s.hasOwnProperty("query") ? s.query : h,
    ...
    function jt(t, e, r, n) {
        var o = Et(t, (function(t, n, o, i) {
            var a = function(t, e) {
                return "function" != typeof t && (t = H.extend(t)),
                t.options[e]
            }(t, e);
            if (a)
    ...
    _t.prototype.transitionTo = function(t, e, r) {
        ...
        this.confirmTransition(n, (function() {
            ...
            r && r(t),
            t && !o.ready && (Rt(t, yt.redirected) && i === h || (o.ready = !0,
    ...
    _t.prototype.confirmTransition = function(t, e, r) {
        ...
        if (v(t, o) && u === c && t.matched[u] === o.matched[c])
            ...
            s(((a = wt(i = o, t, yt.duplicated, 'Avoided redundant navigation to current location: "' + i.fullPath + '".')).name = "NavigationDuplicated",
            a));
        var p = function(t, e) {
    ...
    function Pt(t) {
        var e = window.location.pathname
          , r = e.toLowerCase()
          , n = t.toLowerCase();
        return !t || r !== n && 0 !== r.indexOf(x(n + "/")) || (e = e.slice(t.length)),
